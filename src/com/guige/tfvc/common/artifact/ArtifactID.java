 ...
 * <p/>
 * An artifact ID is composed of 3 parts: a tool, an artifact type, a tool-specific identifier
 * <p/>
 ...
 * following form: vstfs:///tool/artifact-type/tool-specific-identifier
 */
public class ArtifactID {
     ...
     *
     * @param tool           the tool part of the artifact id
     * @param artifactType   the artifact type part of the artifact id
     * @param toolSpecificId the tool specific id part of the artifact id
     */
     ...
     *
     * @param uri the uri to decode and create an artifact id from
     * @throws MalformedURIException if the uri is not well-formed
     */
     ...
     * @throws MalformedArtifactIDException if this artifact id is not well-formed
     */
